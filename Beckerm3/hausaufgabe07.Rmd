...
good_stu <- (pnorm(15,mean=mu,sd=3) - pnorm(10,mean=mu,sd=3) ) * n
...
zeins <- qnorm(1-0.06)
output.zeins <- paste("Der kritische Wert für einen einseitigen $z$-Test ist ",zeins )
print(output.zeins)

zzwei <- qnorm(1-(0.5*0.06))
output.zzwei <- paste("Der kritische Wert für einen zweiseitigen $z$-Test ist ",zzwei )
print(output.zzwei)
...
# z= wurzel(n)*((Mittelwert-alter Mittelwert)/Stabw.)
n <- 7
x <- 10
x.a <- 8
Stabw <- 3
z <- sqrt(n)*((x-x.a)/Stabw)
print(z)

Das ist ein **insignifikanter** Unterschied. (Z-Wert kleiner als zweiseitiger Z-Test)
...
Das ist ein **insignifikanter** Unterschied. (Z-Wert größer als zweiseitiger z-Test)
...
Das ist ein **signifikanter** Unterschied. (Z-Wert kleiner als zweiseitiger Z-Test)
