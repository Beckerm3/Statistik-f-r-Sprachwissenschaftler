...
for(s in c(3,4,5) ){
  ...
  output <- paste("Bei einer Standabweichung von",s, "erreichen",durchfall*100,"% sehr gute Noten.")
  print(output)
}

Wie steht die Anzahl guter Noten in Beziehung zur Anzahl schlechter Noten? 

sollten die Zahlen mit der leicht veränderten Formel stimmen, müsste es häufiger gute, als schlechte Noten geben.
...
Da die guten Noten auf der rechten Seite stehen und diese Seite "breiter" ist, müsste die Verteilung rechtsschief sein.
...
--> hier gab es erst folgenden Error: Error in eval(expr, envir, enclos) : coult not find function "dsn"... was bedeutet dsn in diesem Zusammenhang?? Der Fehler hat sich erst erledigt, nachdem ich manuell das Package "sn" zugefügt habe!
...
med_stu <- (pnorm(9,mean=mu,sd=3) - pnorm(7,mean=mu,sd=3) ) * n
output <-paste(med_stu,"Studenten bekommen zwischen 7 und 9 Notenpunkten.")
print(output)
...
good_stu <- (pnorm(16,mean=mu,sd=3) - pnorm(10,mean=mu,sd=3) ) * n
output <-paste(good_stu,"Studenten bekommen mindestens 10 Notenpunkte.")
print(output)

3. Wie viele Studenten bekommen weniger als 10 NP?

bad_stu <- (pnorm(10,mean=mu,sd=3) - pnorm(0,mean=mu,sd=3) ) * n
output <-paste(bad_stu,"Studenten bekommen mindestens 10 Notenpunkte.")
print(output)

4. Wie viele Studenten bekommen weniger als 8 NP?

Acht_stu <- (pnorm(8,mean=mu,sd=3) - pnorm(0,mean=mu,sd=3) ) * n
output <-paste(Acht_stu,"Studenten bekommen mindestens 10 Notenpunkte.")
print(output)
